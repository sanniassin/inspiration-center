/**
 * parser.js: parser https://github.com/egg-/video-parser
 */
  ...
  request(url, function (err, res, body) {
    ...
    self.loadYoutubeChannel(function (err, channel) {
      ...
      cb(err, {
        ...
        normalImage: snippet.thumbnails.medium.url,
        highResImage: snippet.thumbnails.maxres.url,
...
Parser.prototype._requestVimeo = function (cb, id) {
  ...
  request({
    ...
    cb(err, {
      ...
      thumb_url: result.pictures[5].link,
      lowResImage: result.pictures[4].link,
      normalImage: result.pictures[2].link,
      highResImage: result.pictures[1].link,
